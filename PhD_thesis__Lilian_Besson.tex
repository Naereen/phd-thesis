...
\begin{document}
	...
	\begin{spacing}{0.93}
		...
		\begin{quote}
			...
			Tyrion Lannister, played by Peter Dinklage. \emph{Game of Thrones}, Season 6, Episode 2, ``Home''.
		\end{quote}
		\end{small}

		\begin{small}
			\begin{quote}
				\emph{-- Well, my brother has his sword, and I have my mind. A mind needs books like a sword needs a whetstone, if it is to keep its edge. That is why I read so much, Jon Snow.}
