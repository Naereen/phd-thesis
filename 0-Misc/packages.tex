...
\definecolor{darkblue}{rgb}{0,0,126}         % rgb(0,0,126)
...
\definecolor{deepgold}{RGB}{205,105,0}       % rgb(205,105,0)
\definecolor{Rouge}{RGB}{204,0,0}            % rgb(204,0,0)
\definecolor{darkred}{RGB}{174,0,0}          % rgb(174,0,0)
\definecolor{Highlight}{RGB}{251,0,0}        % rgb(251,0,0)
\definecolor{gold}{RGB}{255,184,0}           % rgb(255,184,0)
...
\ifsetDraft
	...
	\newcommand{\TODOE}[1]{\todo[inline,color=green!40]{Emilie: #1}}
	\newcommand{\TODOL}[1]{\todo[inline,color=blue!40]{Lilian: #1}}
	\newcommand{\TODOC}[1]{\todo[inline,color=purple!40]{Christophe: #1}}
