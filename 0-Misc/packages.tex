...
\renewcommand{\listingscaption}{Code Example}% Listing -> Algorithm
\renewcommand{\listoflistingscaption}{List of Code Examples}% List of Listings -> List of Algorithms
