...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[>=latex',line join=bevel,scale=2.25]
        ...
        \node[align=center] (chapter25) at (-2.5,2.25) [rectangle,draw] {Chapter~\ref{chapter:25}\\Sélection séquentielle\\d'algorithme MAB};
        ...
        \node[align=center] (appendix) at (2.5,-0.25) [rectangle,draw] {Appendices};
        %
