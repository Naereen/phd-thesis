...
I also thank my \href{https://perso.crans.org/besson/zero-dechet/}{bike} which I enjoyed riding everyday despite the too many accidents and rain, my \href{https://perso.crans.org/besson/cuisine/}{enthusiastic daily cooking} which gave me smiles and energy, and finally my \href{https://perso.crans.org/besson/}{favorite open-soure technological tools}: git (and GitHub and Bitbucket) ; \LaTeX, Bash, Julia and Python ; GNU/Linux and XUbuntu, Firefox, Konsole and Visual Studio Code, and many other great free and open-source tools.
Some people thank God in their thesis, I feel that I prefer to thank the Earth, and apologize for the too many times I took a plane for a conference abroad, and in general apologize for the environmental impact of this research work. I'll try hard to do better from now on!
