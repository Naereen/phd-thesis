...
\nomenclature[L]{$M$}{Maximum number of retransmission of a packet in the ALOHA protocol in Chapter~\ref{chapter:4}, and number of player for multi-players bandit games in Chapter~\ref{chapter:5}}
