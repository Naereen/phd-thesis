...
We confirmed from both a numerical simulations and an validation on real radio traffic and hardware that our proposal is an excellent candidate to start to solve the spectrum scarcity issue for unlicensed bands, that is cheap and easy to deploy, and requires .
...
As this approach does not seem theoretically promising, as we illustrated in Section~\ref{sec:25:theory},
