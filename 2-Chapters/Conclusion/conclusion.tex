...
This promising research direction is left for future work,  but the hope is that the regret would be expressed in term of the number of such meaningful changes, instead of the number of break-points $\Upsilon_T$.
