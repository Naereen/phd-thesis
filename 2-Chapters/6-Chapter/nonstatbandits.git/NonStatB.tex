...
\begin{leftbar}[lemmabar]  % XXX leftbar lemmabar, comment if needed
    If $\bP_{\mu_0}$ is a probabilistic model under which $X_t \in [0,1]$,
    and $\forall t, \E_{\bP_{\mu_0}}[X_t] = \mu_0$,
    ...
    then the B-GLRT test $\widehat{\tau}_\delta$ (from Definition~\ref{def:6:GLRDef}) satisfies
