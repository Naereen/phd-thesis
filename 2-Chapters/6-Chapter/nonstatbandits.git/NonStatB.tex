...
\end{equation}
%
Indeed, as proved in Appendix~\ref{app:6:GLR_with_kl} (see also equation $(1.9)$ from \cite{LaiXing10}), we can show that in any one-dimensional exponential family, we have
