...
%
Additionally, we include the \ExpThreeS{} algorithm from \cite{Auer02NonStochastic}, setting its parameters as in their Corollary~8.3: $\omega=1/T$ and $\gamma = \min(1, \sqrt{K (\Upsilon_T \log(KT) + \e) / ((\e-1)T)})$, based on a prior knowledge of $T$ and $\Upsilon_T$.
