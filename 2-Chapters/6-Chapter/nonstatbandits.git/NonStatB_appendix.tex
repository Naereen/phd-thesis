...
% ----------------------------------------------------------------------------
\subsection{Exploring different threshold functions}\label{sec:6:exploringDifferentThresholdFunctions}
...
% ----------------------------------------------------------------------------
\subsection{Exploring different mechanisms to enforce uniform exploration of all arms}\label{sec:6:exploringDifferentForcedExplorationMechanisms}
