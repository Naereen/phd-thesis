...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Mean regret $\pm$ $1$ standard-deviation, for different choices of $\alpha_0\in[0,1]$ on three problems of horizon $T=5000$, for \GLRklUCB{} with \textbf{local restarts}, with $\alpha_T = \alpha_0\sqrt{\Upsilon_T \log(T)/T}$.}
...
%
% In the three experiments, \GLRklUCB{} performs closely to the Oracle-Restart \klUCB{}, and outperforms all or almost all the other approaches, for all choices of $\delta_0$.
We observe in Table~\ref{table:6:sensibilityDelta} that the parameter $\delta_0$ has a significative impact on the performance,
and that choosing $\delta_0 = 1$ is indeed the optimal choice.

\TODOL{I should do the same for the confidence level $\delta$}
...
\begin{table}[ht]
    ...
    \begin{tabular}{c|cccccc}
        ...
        \hline
        $\delta_0=1000$       & $65 \pm 31$ & $106 \pm 35$ & $XXX$ \\
        $\delta_0=500$        & $70 \pm 28$ & $104 \pm 35$ & $XXX$ \\
        $\delta_0=100$        & $72 \pm 32$ & $105 \pm 34$ & $XXX$ \\
        $\delta_0=50$         & $72 \pm 32$ & $112 \pm 31$ & $XXX$ \\
        $\delta_0=10$         & $75 \pm 32$ & $107 \pm 31$ & $XXX$ \\
        $\delta_0=5$          & $76 \pm 31$ & $103 \pm 30$ & $XXX$ \\
        $\mathbf{\delta_0=1}$  & $72 \pm 32$ & $111 \pm 30$ & $XXX$ \\
        $\delta_0=0.5$        & $72 \pm 30$ & $117 \pm 35$ & $XXX$ \\
        $\delta_0=0.1$        & $70 \pm 29$ & $111 \pm 29$ & $XXX$ \\
        $\delta_0=0.05$       & $68 \pm 29$ & $116 \pm 37$ & $XXX$ \\
        $\delta_0=0.01$       & $74 \pm 29$ & $114 \pm 32$ & $XXX$ \\
        $\delta_0=0.005$      & $76 \pm 26$ & $114 \pm 34$ & $XXX$ \\
        $\delta_0=0.001$      & $76 \pm 29$ & $117 \pm 34$ & $XXX$ \\
    \end{tabular}
    \caption{Mean regret $\pm$ $1$ standard-deviation, for different choices of $\delta_0\in(0,100]$ on three problems of horizon $T=5000$, for \GLRklUCB{} with $\delta=\delta_0 / \sqrt{\Upsilon_T T}$.}
...
\begin{enumerate}
    ...
    \[ \beta_1(n, \delta) := \log\left(\frac{3 n^{3/2}}{\delta}\right) = \log(\frac{1}{\delta}) + \log(3) + 3/2 \log(n). \]
...
Therefore, the choice of threshold function $\beta_1(n, \delta) := \log\left(\frac{3 n^{3/2}}{\delta}\right)$ for our proposal \GLRklUCB{} presented in Algorithm~\ref{algo:6:GLRklUCB} is validated by these experiments, and this choice gives good empirical performance.
