...
We compare the following threshold functions that can be used in the B-GLRT test used for the \GLRklUCB{} algorithm.

\begin{enumerate}
    \item
    The first variant is the default one, advised in for \GLRklUCB{}:
    ...
    The function $\cT$ is computed with a numerical approximation of the Lambert function $\W$, as explained in Section~\ref{par:6:falseAlarm},
    \[ \beta_3(t, \delta) := 2 \mathcal{T}\left(\frac{\log(2 t^{3/2}) / \delta}{2}\right) + 6 \log(1 + \log(t)). \]

    \item
    The last variant is using a $\tilde{\mathcal{T}}(x) = x + 4 \log(1 + x + \sqrt{2x})$ a simply approximation of $\cT(x)$, which is valid and quite accurate as soon as $x \geq 5$,
...
\begin{table}[ht]
    ...
    \begin{tabular}{c|cccccc}
        ...
        \hline
        $\beta_1(n,\delta)$ & $51 \pm 29$ & $79 \pm 35$ & $82 \pm 45$ \\
        $\beta_2(n,\delta)$ & $38 \pm 29$ & $70 \pm 35$ & $76 \pm 39$ \\
        $\beta_3(n,\delta)$ & $33 \pm 29$ & $69 \pm 31$ & $68 \pm 32$ \\
        $\beta_4(n,\delta)$ & $33 \pm 29$ & $69 \pm 31$ & $68 \pm 32$
    \end{tabular}
...
and that this choice of threshold function $\beta_1$ gives good performance for our proposal \GLRklUCB.
...
\begin{enumerate}
    \item
    \textbf{Uniform random exploration}:
    FIXME describe it precisely!
    \item
    \textbf{Deterministic exploration}:
    FIXME describe it precisely!
    \item
    \textbf{Tracking-based exploration}:
    FIXME describe it precisely!
\end{enumerate}
...
\begin{table}[ht]
    ...
    \begin{tabular}{c|cccccc}
        ...
        \hline
        Uniform random exploration & $51 \pm 29$ & $79 \pm 35$ & $82 \pm 45$ \\
        Deterministic exploration & $38 \pm 29$ & $70 \pm 35$ & $76 \pm 39$ \\
        Tracking-based exploration & $33 \pm 29$ & $69 \pm 31$ & $68 \pm 32$
    \end{tabular}
