...
in case of RF (up-link or down-link) collision that prevent the device to receive the \emph{Ack} from the gateway,
...
We also consider in these experiment the case of an ALOHA protocol using $\mathrm{MaxBackOff}=5$, and $m=10$, a statistic distribution of the devices about $40\%, 30\%, 20\%, 10\%$ for the four channels, and $N=2000$ IoT devices.
