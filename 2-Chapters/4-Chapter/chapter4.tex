...
\paragraph{Multi-Players MAB with \emph{collision avoidance}.}
...
Instead of the direction pursued in this chapter, another possibility is to consider a \emph{multi-players MAB} model to describe our problem, as proposed by \cite{Zhao10}.
