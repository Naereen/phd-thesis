...
\begin{itemize}\tightlist
    \item
    \UCB{} (or Thompson sampling) is used in the more applied Chapter~\ref{chapter:4}, when simplicity is favored,
    \item
...
In Figure~\ref{fig:3:16_different_algorithms__lognormregret_vs_logtime__28pb}, we can see FIXME
...
In Figure~\ref{fig:3:16_different_algorithms__lognormregret_vs_logmemory__28pb}, we can see FIXME
...
\begin{figure}[h!]  % [htbp]
	...
	\caption[Normalized memory cost vs different values of $T$.]{
        ...
        for $K=32$ and for $16$ algorithms.
        $y$-axis is in log-scale.
        All algorithms (except BESA) has a very slowly growing normalized memory cost, meaning that for $T$ rounds they use a computation time almost independent of $T$, as predicted: $\cM_T = \bigO{K}$.
