...
%
In Chapter~\ref{chapter:5}, we use SMPyBandits to simulate multi-player bandit problems, and we also present many extensions of this model.
Some have already been implemented, but other extensions are yet to be added.
This direction is one of the major future work left on our library
