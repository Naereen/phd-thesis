...
We chose to present here our Python library SMPyBandits in this chapter rather than in the Appendix, because all the numerical experiments on single-player multi-arm bandits in Chapter~\ref{chapter:25}, and on more sophisticated models in the last two Chapters~\ref{chapter:5} and \ref{chapter:6} are built on our library.
%
