...
By showcasing an interactive demonstration made available online\footnote{~The demo is hosted on my website, at \href{https://perso.crans.org/besson/phd/MAB\_interactive\_demo/}{\texttt{perso.crans.org/besson/phd/MAB\_interactive\_demo/}}.}, we presented the notations used in all this thesis.

We ended this chapter by presenting the first contribution of this manuscript \cite{Besson2018WCNC}, in Section~\ref{sec:2:chooseYourPreferredBanditAlgorithm}. We tackle the question of how to select a particular bandit algorithm when a practitioner is facing a particular (unknown) bandit problem.
...
We proposed an extension of the Exp4 algorithm for this problem, \Aggr, and illustrate its performance on a set of small bandit problems.
%
