...
We first give in Table~\ref{table:2:oneShotResult} the cumulated rewards as well as the regret of the different algorithms, \emph{for one simulation}.
...
\begin{table}[ht]
    \begin{small}  % WARNING
        ...
        \textbf{Algorithms} $\;$ \textbackslash $\;$ Horizon & Reward & Regret $T=100$ & Reward & Regret $T=10000$ \\
            \hline
            Pure exploration
                & $XXX$ & $XXX$
                & $XXX$ & $XXX$ \\
