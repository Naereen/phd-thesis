...
%
The Algorithm~\ref{algo:2:indexPolicy} below details a generic index policy, that include well known and efficient algorithms such as $\UCB_1$, \klUCB{} and many others.
