...
We also focus on real-valued rewards, meaning that $r_k(t)\in\R$ for all $k$ and $t$.
...
\TODOL{On garde ce petit paragraphe, par curiosité ?}
...
This research field has been very active since the years 2010s, but it started as early as 1933 with \cite{Thompson33}, and was active since the 1980s \cite{LaiRobbins85,Anantharam87a,Anantharam87b}.
...
\cite{Jouini09,Jouini10,Jouini12}
\cite{MoyWSR2014}
\cite{RobertSDR2014}
\cite{modiDemo2016,Modi17QoS}
