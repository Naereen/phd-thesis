...
\begin{figure}[h!]  % [htbp]
	% \centering
    \includegraphics[width=1.23\linewidth]{SP__K5_T10000_N1000__7_algos/main_MeanRewards____env1-1_2506036032481767447.pdf}
...
\begin{figure}[h!]  % [htbp]
	% \centering
	\includegraphics[width=1.17\linewidth]{SP__K5_T10000_N1000__7_algos/main____env1-1_2506036032481767447.pdf}
...
%
For both directions, we present in the two final chapters of this thesis natural extensions of the base model, and we detail our contributions that obtained state-of-the-art results for the two problems
