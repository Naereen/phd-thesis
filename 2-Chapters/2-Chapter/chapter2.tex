...
the Wikipedia \href{https://en.wikipedia.org/wiki/Multiplicative_weight_update_method}{\texttt{en.wikipedia.org/wiki/Multiplicative\_weight\_update\_method}},
...
$\Pr(C(t)=k) = (1-\gamma) w_k(t) + \gamma \frac{1}{K}$.
...
This notation $\widehat{r_k}(t)$ means an unbiased estimator of the reward $r_k(t)$, that is, $\widehat{r_k}(t) = \Pr(C(t)=k)$.
%
