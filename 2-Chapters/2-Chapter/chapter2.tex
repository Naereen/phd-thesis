...
In particular, we highlight that \klUCB{} achieves a finite-time regret upper-bound, that matches the asymptotical lower-bound of Lai and Robbins \cite{LaiRobbins85} for Bernoulli distributed problems, which is our main focus of interest in both Chapters~\ref{chapter:5} and \ref{chapter:6}.
...
\begin{figure}[h!]  % [htbp]
	% \centering
	\includegraphics[width=1.12\linewidth]{SP__K5_T10000_N1000__3_algos/main____env1-1_776571591054077529.pdf}
	...
	\label{fig:2:meanRegretAsFunctionOfTimeForDifferentAlgorithmsT10000N1000__FIXME}
\end{figure}
