...
We remind that we consider bounded rewards in $[0,1]$.
...
then the \klUCB{} indexes are defined as follows
...
\begin{figure}[h!]
	...
	\begin{algorithm}[H]
		...
		\caption{Thompson Sampling for Bernoulli rewards, with a Beta prior on each arm, and also Beta posteriors.}
