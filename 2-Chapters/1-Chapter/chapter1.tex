...
The manuscript is organized in two parts and six chapters, and the reading order can be any top-down path between Chapter~\ref{chapter:1} and the Conclusion in Chapter~\ref{chapter:conclusion}, in the graph shown in Figure~\ref{fig:1:organization} below.
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[>=latex',line join=bevel,scale=2.25]
        %
        \node[align=center] (introduction) at (0,3) [rectangle,draw] {Chapter~\ref{chapter:1}\\Introduction};
        \node[align=center] (chapter2) at (0,2) [rectangle,draw] {Chapter~\ref{chapter:2}\\Stochastic and Stationary\\Multi-Armed Bandit models};
        \node[align=center] (chapter3) at (2.5,2) [rectangle,draw] {Chapter~\ref{chapter:3}\\SMPyBandits: simulation\\library for MAB};
...
\item
    ...
    1st International ISIoT workshop\footnote{\href{https://sites.google.com/view/ISIoT2019}{\texttt{sites.google.com/view/ISIoT2019}}},
...
\item
    ...
    1st International MOTIoN workshop\footnote{\href{https://sites.google.com/view/wcncworkshop-motion2019}{\texttt{sites.google.com/view/wcncworkshop-motion2019}}},
...
\item
    ...
    \emph{Wireless Communication and Networks Conference}\footnote{IEEE WCNC, \href{http://wcnc2019.ieee-wcnc.org}{\texttt{wcnc2019.ieee-wcnc.org}}}, Marrakech, Morocco, April 2019,
...
\item
    ...
    \emph{Algorithmic Learning Theory}\footnote{ALT, \href{http://www.cs.cornell.edu/conferences/alt2018}{\texttt{www.cs.cornell.edu/conferences/alt2018}}}, Lanzarote, Spain, April 2018,
...
\item
    ...
    \emph{Wireless Communication and Networks Conference}\footnote{IEEE WCNC, \href{http://wcnc2018.ieee-wcnc.org}{\texttt{wcnc2018.ieee-wcnc.org}}}, Barcelone, Spain, April 2018,
...
\paragraph{Responsabilities}
    ...
    I also helped for the organization and presented another poster\footnote{Cf. \href{https://HAL.Inria.fr/hal-02013847}{\texttt{HAL.Inria.fr/hal-02013847}}} at the ``IETR : Interagir Évaluer Transmettre Réunir'' seminar, held in Vannes in June $2018$.

\paragraph{Reviews}
	for \emph{European Workshop on Reinforcement Learning}\footnote{Cf. \href{https://ewrl.wordpress.com/ewrl14-2018}{\texttt{ewrl.wordpress.com/ewrl14-2018}}} (Lille), in October $2018$, I reviewed $5$ papers.
