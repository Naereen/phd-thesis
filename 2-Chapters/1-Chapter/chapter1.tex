...
\TODOL{Mardi soir : je dois encore relire le 1.1 pour les fautes d'orthographe (et les éventuels erreurs historiques) !}
...
\item
    ...
    \cite{MoyBesson2019}
    Note that we are already working on an extended version that will be submitted to a journal in July $2019$.
...
\item
    ...
    \cite{Besson2019GLRT}
    Note that we are already working on an extended version that will be submitted to a journal in autumn $2019$.
