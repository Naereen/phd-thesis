...
\TODOL{Ecrire les 1.1 et 1.2 en quelques paragraphes}
...
%
The organization of this manuscript is detailed in a flow graph, which highlights that Chapters~\ref{chapter:4} to \ref{chapter:6} are partly independent, but all use the notations introduced on Chapter~\ref{chapter:2}.
...
All the publications are published on HAL (see the \href{https://hal.archives-ouvertes.fr/}{\texttt{HAL.Archives-Ouvertes.fr}} website),
and the complete list can be found on
