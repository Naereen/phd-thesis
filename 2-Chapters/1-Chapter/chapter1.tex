...
During the last 150 years, mankind has developed a wide range of different communication technologies, and since the $1920$s wireless communications between devices have been made possible, and more and more frequent in our lives.
...
More precisely, we study the possible interconnections between Cognitive Radio and Machine Learning, applied to IoT networks.
...
Cognitive Radio (CR) is not a standard technology, and as such it does not have a single definition, so let us start by quoting the definition of two researchers whose works were the roots of the development of CR, since the last $20$ years.
...
% FIXME how to explain spectrum scarcity?
...
% FIXME how to explain PU and SU in a few sentences?
In such licensed bands, Primary Users (PU) pay to access the network, and they have a priority over 
But even though the RF bands are allocated, real world measurements often show that some bands are not densely used.
% FIXME how to explain DSA ?
The concept of Dynamic Spectrum Access (DSA) was thus proposed in the early $2000$s, 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.90\textwidth]{machine-learning-map.pdf}
...
The goal of the player is to maximize its reward.
Many real-world problems can be framed as Reinforcement Learning problems \cite{bouneffouf2019survey}, for instance learning to walk or to drive, learning to play a game, or discovering which treatment is efficient in healing a certain disease.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.20\textwidth]{Illustration_of_Reinforcement_Learning_action-reward_loop.png}
...
\paragraph{Previous work in the SCEE team.}
