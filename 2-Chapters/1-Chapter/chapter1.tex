...
\TODOL{Mardi soir : je dois encore tout relire et améliorer un peu !}
...
% \textbf{Main problems.}
%
At the root of the problems that motivate this thesis are the questions of global warming and the increase of the world population.
% https://en.wikipedia.org/wiki/History_of_radio
During the last 150 years, mankind has developed a wide range of different communication technologies, and since the late $1890$s wireless communications between man-made manufactured devices have been made possible, and more and more frequent in our lives.
...
directly into the future IoT devices, in order to improve their battery life and reduce the energy cost of IoT networks, by optimizing their wireless communications and learning to be self-organized, thanks to embedded decentralized decision making.
...
More precisely, in this thesis we focus on Reinforcement Learning models, in particular the learner does not have access to the entire reaction of the environment after taking its action.
...
\subsection{Our model of IoT network and decentralized MAB}
