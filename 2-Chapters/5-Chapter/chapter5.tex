...
FIXME
\TODOL{FIXME écrire ça sans être fini}
...
We do not review papers that study this model, because the recent work \cite{BoursierPerchet18} introduced the ``communication trick''.
Recent research efforts have been more focus on studying the basic model --without explicit communications between players--, while proposing algorithms that can rely on some communication between players.
This ``communication trick'' is used for instance in \cite{KaufmannAbbas19}.
