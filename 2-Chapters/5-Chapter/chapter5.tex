...
% \begin{footnotesize}
    ...
    \textbf{Algorithms} $\;$ \textbackslash $\;$ \textbf{Number of players} & $M=3$ & $M=6$ & $M=9$ \\
        ...
        \hline
        \RhoRand-\klUCB{} & $417 \pm 103$ & $2481 \pm 449$ & $2351 \pm 55$ \\
        \RhoRand-\klUCB{} + \textcolor{red}{Estimate $M$} & \textcolor{red}{$1422 \pm 1051$} & \textcolor{red}{$9030 \pm 1922$} & \textcolor{red}{$2403 \pm 121$} \\
        \hline
        \RandTopM-\klUCB{} & $268 \pm 45$ & $941 \pm 217$ & $790 \pm 470$ \\
        \RandTopM-\klUCB{} + \textcolor{red}{Estimate $M$} & \textcolor{red}{$688 \pm 614$} & \textcolor{red}{$4256 \pm 2701$} & \textcolor{red}{$1098 \pm 153$} \\
        \hline
        \MCTopM-\klUCB{} & $244 \pm 39$ & $401 \pm 55$ & $42 \pm 5$ \\
        \MCTopM-\klUCB{} + \textcolor{red}{Estimate $M$} & \textcolor{red}{$563 \pm 546$} & \textcolor{red}{$1560 \pm 1293$} & \textcolor{red}{$602 \pm 54$} \\
        \hline
        \Selfish-\klUCB{} & $250 \pm 34$ & $735 \pm 85$ & $1379 \pm 16$ \\
        \hline
    \end{tabular}
...
The three algorithms \RhoRand, \RandTopM{} and \MCTopM{} all suffer from similar costs on their regret when they have to estimate $M$ on the fly. Our proposals are still much more efficient than \RhoRand{} when using the procedure to estimate $M$ described from \cite{Anandkumar11}.
For the two non-extreme cases ($M=3,6$), the performance drop when having to estimate $M$ is quite large (on the three algorithms and two cases, about $+30\%$), and consistent on the different algorithm.
The extreme case of $M=K$ players is of highest interest, as \MCTopM{} achieves a very small regret (proved to be $\smallO{\log(T)}$ as it is just the expected time of the orthogonalization process), while the same algorithm with unknown $M$ suffers from a much larger regret (written ``Estimate $M$'' in Table~\ref{table:5:meanRegretSimulationsEstimatingM}).
In this extreme case, \RhoRand{} and its extension both perform very closely, as expected.
%
Additional simulations, for increasing time horizons $T$, confirmed the expected order-optimal regret of this extension \MCTopM-\klUCB.
...
% FIXME run the simulations with N=100 and not N=4
...
% \begin{footnotesize}
    ...
    \textbf{Algorithm} $\;$ \textbackslash $\;$ Number of players & $M=3$ & $M=6$ & $M=9$ \\
        ...
        Centralized multiple-play \klUCB{} & $\mathbf{92 \pm 20}$ & $\mathbf{70 \pm 16}$ & $\mathbf{0}$ \\
        \hline
        \RhoRand-\klUCB{} & $417 \pm 103$ & $2481 \pm 449$ & $6044 \pm 744$ \\
        \hline
        \texttt{rhoLearn}-\klUCB{} + \klUCB{} & $546 \pm 190$ & $1172 \pm 295$ & $1193 \pm 303$ \\
        \texttt{rhoLearn}-\klUCB{} + Bayes-UCB & $561 \pm 219$ & $1204 \pm 394$ & $1158 \pm 133$ \\
        \texttt{rhoLearn}-\klUCB{} + Exp3 & $529 \pm 175$ & $1659 \pm 331$ & $5222 \pm 813$ \\
        \hline
        \MCTopM-\klUCB{} & $244 \pm 39$ & $401 \pm 55$ & $39 \pm 3$ \\
        \hline
    \end{tabular}
