...
Some works studied the same model as our model \modeldeux{} ``with sensing'', under the hypothesis


\paragraph{Extension of our proposals to learn the value of $M$?}

Similarly to what was proposed for the \rhoRandEst{} algorithm, we could have worked on proposing and analyzing an extension of our proposals that could efficiently learn the value of $M$ the number of player.
...
\cite{BoursierPerchet18}


Distributed Learning and Optimal Assignment in Multiplayer Heterogeneous Networks
H Tibrewal, S Patchala, MK Hanawal - arXiv preprint arXiv …, 2019 - arxiv.org
https://arxiv.org/pdf/1901.03868.pdf
\cite{Tibrewal2019}
``communication/collision trick''
