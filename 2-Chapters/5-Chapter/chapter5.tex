...
Each device has data to transmit at every instant, that is we restrict to the case of an activation probability of $p=1$, because it was found very hard to analyze the previously studied IoT network models, under the hypothesis of random activation patterns of Chapter~\ref{chapter:4}.
%
