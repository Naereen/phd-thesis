...
Finally, the very recent work of \cite{Zafaruddin2019} is the first one to present experiments done on simulated LTE and 5G channels.
...
The first \texttt{rhoLearn} uses Bayes-UCB for the second-stage learning, while the second uses Exp3,
and we include both the centralized multi-play version of \klUCB{} and our proposal \MCTopM-\klUCB{} for comparison.

% FIXME run the simulations!
\begin{table}[ht]
% \begin{footnotesize}
    \centering
    \begin{tabular}{c|ccc}
    \textbf{Algorithm} $\;$ \textbackslash $\;$ Number of players & $M=3$ & $M=6$ & $M=9$ \\
        ...
        \hline
        \RhoRand-\klUCB{} & $297 \pm 18$ & $1411 \pm 144$ & $2351 \pm 55$ \\
        \texttt{rhoLearn}-\klUCB{} + Bayes-UCB & $297 \pm 18$ & $1411 \pm 144$ & $2351 \pm 55$ \\
        \texttt{rhoLearn}-\klUCB{} + Exp3 & $297 \pm 18$ & $1411 \pm 144$ & $2351 \pm 55$ \\
        \hline
        \MCTopM-\klUCB{} & $134 \pm 6$ & $304 \pm 19$ & $42 \pm 5$ \\
        \hline
    \end{tabular}
