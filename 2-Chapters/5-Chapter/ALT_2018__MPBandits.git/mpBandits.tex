...
Regardless of whether sensing is or not possible, we present formally in Section~\ref{sub:5:Selfish} the \Selfish{} policy, as used by all the IoT devices in the first model presented in Chapter~\ref{chapter:4}.
...
% -----------------------------------------------------------------
\subsection{The \Selfish{} heuristic for the ``no sensing case''}
\label{sub:5:Selfish}
...
We show in Section~\ref{sub:5:SelfishFails} that \Selfish{} does have a (very) small probability to fail (badly), for some problem with small $K$,
...
\begin{figure}[!h]
  ...
  % \begin{subfigure}[!h]{0.75\textwidth}
      \includegraphics[width=0.90\textwidth]{MP__K17_M6_T10000_N100__4_algos/all_RegretCentralized_loglog____env1-1_4163066365888233475.pdf}
  % \end{subfigure}
  % ~
  % \begin{subfigure}[!h]{0.75\textwidth}
      \includegraphics[width=0.90\textwidth]{MP__K17_M12_T10000_N100__4_algos/all_RegretCentralized_loglog____env1-1_3856003705095179548.pdf}
  % \end{subfigure}
  % ~
  % \begin{subfigure}[!h]{0.75\textwidth}
      \includegraphics[width=0.90\textwidth]{MP__K17_M17_T10000_N100__4_algos/all_RegretCentralized_loglog____env1-1_8969236287861113966.pdf}
  % \end{subfigure}
