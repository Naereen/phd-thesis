...
\begin{leftbar}[warningbar]  % XXX leftbar warningbar, comment if needed
  ...
  as it was discovered by V. Boursier and E. Perchet, as they explain in Section~2.4 in \cite{BoursierPerchet18}.
...
we use the Kullback-Leibler divergence to express this lower bound.
...
To the best of the authors' knowledge, no algorithm has been shown to experience only $o(\log(T))$ collisions so far,
...
For the proposal \MCTopM, we are furthermore able to obtain a logarithmic regret upper bound, by proposing an original approach to control the number of collisions under this algorithm.
...
\begin{figure}[!t]
  ...
  % % ~
  % \begin{subfigure}[!h]{0.49\textwidth}
    \includegraphics[width=0.95\textwidth]{MP__K9_M6_T5000_N500__4_algos/all_RegretCentralized____env1-1_8318947830261751207.pdf}
  % \end{subfigure}
